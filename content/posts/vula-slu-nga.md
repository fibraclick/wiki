...
I termini VULA, SLU e NGA si utilizzando nell'ambito delle reti di nuova generazione (**NGA**, Next Generation Access), e cioè infrastrutture [FTTC e FTTH]({{< relref "architetture.md" >}}) per la banda larga e ultralarga.
