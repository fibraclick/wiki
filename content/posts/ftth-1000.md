...
In caso di uso contemporaneo della rete la **banda minima garantita** per ciascuna linea non è quindi pari a 2,5 Gbps / il fattore di splititng ma **molto più bassa**. I contratti che prevedono una reale banda minima sono molto costosi e riservati alle aziende.
{{< /warn >}}
