...
{{% green %}}
In Italia quando si parla di connessioni a **"30 Mbps" ci si riferisce all'architettura FTTC**. Questo perché per limiti tecnologici né la VDSL né il wireless riescono (per ora) a garantire in modo consistente più di 100 Mbps in download.
